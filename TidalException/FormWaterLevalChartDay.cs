...
{
    public partial class FormWaterLevelChartDay : Form
    {
        ...
        public FormWaterLevelChartDay(string datafile)
        {
        ...
        private void btnDraw_Click(object sender, EventArgs e)
        {
            ...
            {
                chart1.Titles.Clear();
                chart1.Titles.Add(new Title("日均值——水位"));
                chart1.Series.Clear();           
                chart1.DataSource = list;
                chart1.Series.Add("水位日均值");
