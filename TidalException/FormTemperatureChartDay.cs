...
{
    public partial class FormTematureChartDay : Form
    {
        ...
        public FormTematureChartDay(string datafile)
        {
        ...
        private void btnDraw_Click(object sender, EventArgs e)
        {
            ...
            {
                chart1.Titles.Clear();
                chart1.Titles.Add(new Title("日均值——气压"));
                chart1.Series.Clear();           
                chart1.DataSource = list;
                chart1.Series.Add("气压日均值");
                ...
                chart1.ChartAreas[0].AxisY.Maximum = (int)max + 100;
                chart1.ChartAreas[0].AxisY.Minimum = (int)min - 100;
                ...
                while ((str = sr.ReadLine()) != null)
                {
                    ...
                    {                         
                        ...
                        if (v < 90000)
                        {
                            ...
                            if (v<min)
                                min= v;
                            //是否是同一天数据，如果是则累计，否则计算平均值
                            if (a[0].Substring(0,8) == prevDay.Substring(0,8))
                            {
                                counter++;
                                total += v;
                            }
